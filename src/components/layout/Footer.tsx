...
export default function Footer({
  logoText = 'Acme SaaS',
  companyDescription = 'Streamline your business operations with our comprehensive SaaS platform. Trusted by over 10,000 companies worldwide to automate workflows, manage teams, and drive growth.',
  contactEmail = 'support@acmesaas.com',
  contactPhone = '+1 (555) 847-2900',
  contactAddress = '2847 Enterprise Blvd, San Francisco, CA 94107',
  newsletterTitle = 'Product Updates',
  newsletterDisclaimer = 'Get weekly insights on SaaS trends and product updates. Unsubscribe anytime.',
  section1Title = 'Platform',
  section2Title = 'Company',
  section3Title = 'Support',
  section4Title = 'Legal',
  copyrightText = '© 2024 Acme SaaS. All rights reserved.',
  madeWithText = 'by the Acme team',
  socialText = 'Connect with us:',
  social1Href = 'https://twitter.com/acmesaas',
  social2Href = 'https://facebook.com/acmesaas',
  social3Href = 'https://instagram.com/acmesaas',
  social4Href = 'https://linkedin.com/company/acmesaas',
  social5Href = 'https://github.com/acmesaas',
}: FooterProps) {
